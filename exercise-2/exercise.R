...
# Read in data
setwd('~/Documents/University of Washington/Junior/Spring Quarter/Info 201/Classwork/m19-special-topics/exercise-2')
...
for(i in 1:100) {
  ...
  result <- rpart(in_sf ~ ., training.data, method = "class")
  ...
  basic.fits <- append(basic.fits, assessment)
}
